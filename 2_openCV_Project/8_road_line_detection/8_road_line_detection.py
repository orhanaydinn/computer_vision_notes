# -*- coding: utf-8 -*-
"""
Created on Sun Mar 23 16:56:08 2025
...
def process(image):
    ...
    lines = cv2.HoughLinesP(cropped_image, rho = 2, theta = np.pi/180, threshold = 150, lines = np.array([]),minLineLength = 150, maxLineGap = 5)
    # print(lines)
